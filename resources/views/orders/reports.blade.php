                    ...
                    @foreach($orders as $orderInfo)
                        ...
                        <table class="table-auto w-full mt-4 mb-4">
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-2">{{ __('Order time') }}</th>
                                <th class="px-4 py-2">{{ __('Delivery time') }}</th>
                                <th class="px-4 py-2">{{ __('Products Amount') }}</th>
